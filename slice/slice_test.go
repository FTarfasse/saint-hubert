...
func TestSlice(t *testing.T) {
	...
	t.Run("Valid string with one link gives one link", func(t *testing.T) {
		...
		got := Slice("<a href=\"https://example.com\"></a>")
	...
	t.Run("Valid string with two links gives two links", func(t *testing.T) {
		links := Slice("<a href=\"https://example.com\"></a><a href=\"https://perdu.com\"></a>")
		got := links[0]
		want := "https://example.com"
		if got != want {
			t.Errorf("got %s want %s", got, want)
	...
	t.Run("Valid string with three links gives three links", func(t *testing.T) {
		links := Slice("<a href=\"https://example.com\"></a><a href=\"https://perdu.com\"></a></a><a href=\"https://whatwhatwhat.com\"></a>")
		got := links[0]
		want := "https://example.com"
		if got != want {
			t.Errorf("got %s want %s", got, want)
